...
class RepulsionPlaneMoving extends PlaneForce {
    ...
    public override particles: BasicElement[] | number = -1;
    public override dir: THREE.Vector3 = new THREE.Vector3(0, 0, 1);
    public override position: number = 0;
    public override stiff: number = 0.09;
