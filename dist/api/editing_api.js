...
(function (edit) {
     ...
     */
    function discretizeDensity(elems, dd, cellsize) {
        ...
        let Positions = elems.map(e => e.getPos());
        ...
        let get_subbox = function (xc, yc, zc, rad) {
            // minimum of subbox
    ...
    edit.discretizeDensity = discretizeDensity;
    /**
