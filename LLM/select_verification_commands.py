...
def select_verification_commands(input_file="LLM/alpaca_dataset.jsonl", output_file="LLM/verification_commands.json"):
    ...
    intent_map = {
        ...
        "Add a cube named": "add_cube",
        "Add a sphere named": "add_sphere",
        "Add a circle named": "add_circle",
        "Add a square named": "add_square",
        "Translate the object named": "translate_named_object",
